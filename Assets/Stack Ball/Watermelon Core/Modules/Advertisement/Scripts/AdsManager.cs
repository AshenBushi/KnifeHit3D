    ...
    public class AdsManager
    {
        ...
        public void Init(AdsManagerInitModule adsManagerInitModule)
        {
            ...
            if (settings.gdprContainer.enableGDPR)
            {
                ...
                {
                    InitModules(GDPRController.GetGDPRState());
                }
            }
            else
            {
        ...
        {
            lastInterstitialTime = TimeUtils.GetCurrentUnixTimestamp() + instance.settings.adsFrequency.interstitialShowingDelay;
        }
        ...
        public static bool ShowRewardBasedVideo(AdvertisingModules advertisingModules, AdvertisingHandler.RewardedVideoCallback callback)
        {
            if (!IsModuleActive(advertisingModules))
                return false;
