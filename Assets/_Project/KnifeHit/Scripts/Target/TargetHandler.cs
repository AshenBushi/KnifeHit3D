    ...
    public void CompleteLevel()
    {
        switch (CurrentSpawnerIndex)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                MetricaManager.SendEvent("target2_com_(" + DataManager.Instance.GameData.ProgressData.CurrentMark2Level + ")");
                LevelManager.Instance.NextMark2Level();
                break;
            case 4:
                MetricaManager.SendEvent("cube2_com_(" + DataManager.Instance.GameData.ProgressData.CurrentCube2Level + ")");
                LevelManager.Instance.NextCube2Level();
                break;
            case 5:
                MetricaManager.SendEvent("disk2_com_(" + DataManager.Instance.GameData.ProgressData.CurrentFlat2Level + ")");
